...
type SalaryPayment struct {
	...
	Month         string    `json:"month" gorm:"type:varchar(50);not null"`
	...
	PaymentDate   string    `json:"paymentDate" gorm:"type:varchar(50);column:payment_date"`
	PaymentMethod string    `json:"paymentMethod" gorm:"type:varchar(100);column:payment_method"`
